...
** Files
   1. [[file:../topics/beginningR.org][Beginning R]]
   2. [[file:../assessments/accessingDatainRAssessment.org][Accessing Data in R (assessment)]]
   3. [[file:../assessments/hangmanRAssessment.org][Hangman in R (assessment)]]
** Videos
...
** A slight digression on Jupyter Notebooks 
