...
* Your goal ...
  is to install a _bootable_, _persistent_, Xubuntu 20.04 iso to a USB (note you can use an SD card and portable hard disc also, but they are not as widely used or as well documented).
